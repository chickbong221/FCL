...
def main(args):
    if args.dataset=='EMNIST-letters' or args.dataset=='EMNIST-letters-shuffle':
        ...
        download = True
        data_train = datasets.CIFAR100(args.datadir, download=download, train=True)
        data_test = datasets.CIFAR100(args.datadir, download=download, train=False)
    ...
    output_dir = os.path.dirname(args.data_split_file)
