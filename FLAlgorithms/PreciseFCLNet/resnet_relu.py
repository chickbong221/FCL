...
def resnet8(input_channels, num_classes, **kwargs: Any) -> ResNet: # 8 = 2 + 2 * (1 + 1 + 1)
    return ResNet(BasicBlock, layers=[1, 1, 1], num_input_channels=input_channels, num_classes=num_classes, **kwargs)
...
class Resnet8_plus(nn.Module):
    def __init__(self, image_size, xa_dim, num_classes = 10):
        ...
        # layers
        self.features = resnet8(input_channels=3, num_classes=self.num_classes)
        channel_size = 256
...
class Resnet18_plus(nn.Module):
    def __init__(self, image_size, xa_dim, num_classes = 10):
        ...
        # layers
        self.features = resnet18(input_channels=3, num_classes=self.num_classes)
        channel_size = 512
        self.fc1 = nn.Linear(channel_size, xa_dim)
        self.fc2 = nn.Linear(xa_dim, xa_dim)
